...
$themes = array('afterdark', 'afternoon', 'afterwork', 'aristo', 'asphalt', 'black-tie', 'blitzer', 'bluesky', 'bootstrap', 'casablanca', 'cruze',
    ...
    'ui-darkness', 'ui-lightness', 'vader', 'znetdk','z-bluegrey','z-cyan','z-funny','z-hot-sneaks','z-teal','z-w10');
...
<script type="text/javascript">
    ...
    $('div.theme-thumbnail > img.theme-image').click(function (event) {
        ...
        var znetdkThemes = ['z-bluegrey','z-cyan','z-funny','z-hot-sneaks','z-teal','z-w10','flat-blue', 'flat-two','znetdk','asphalt','greensea'];
