...
/* Heading images */
define('LC_HEAD_IMG_LOGO',ZNETDK_ROOT_URI . CFG_ZNETDK_IMG_DIR . '/logo.png');

/* Footer labels */
define('LC_FOOTER_LEFT','Version '.SPIMA_VERSION);
define('LC_FOOTER_CENTER','Copyright 2018');
define('LC_FOOTER_RIGHT','2º Ten QAO Lúcio Flávio Lemos - Developer');

/* Home page labels */
define('LC_HOME_WELCOME','Welcome to our Management System');
